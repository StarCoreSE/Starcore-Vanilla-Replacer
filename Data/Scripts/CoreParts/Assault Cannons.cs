...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LargeBlockAssaultCannonTurret => new WeaponDefinition
        {
            ...
            {
                PartName = "Assault Cannon Autoloader", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 594, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
        ...
        WeaponDefinition SmallBlockAssaultCannon => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    PreFiringSound = "", // Audio for warmup effect.
                    FiringSound = "MediumCalibreShot", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
            ...
            Ammos = new[] {
                SmallAssaultCannonShell, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };
        ...
        WeaponDefinition SmallBlockAssaultCannonTurret => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                Loading = new LoadingDef
                {
                    ...
                    MagsToLoad = 1, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 0, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = 70, // Heat generated per shot.
                    MaxHeat = 100, // Max heat before weapon enters cooldown (70% of max heat).
            ...
            Ammos = new[] {
                SmallAssaultCannonTShell, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };
