...
namespace Scripts {   
    partial class Parts
    {
        ...
        WeaponDefinition LargeMissileLauncher => new WeaponDefinition
        {
            ...
            {
                PartName = "Multiple Launched Rockets", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
        ...
        WeaponDefinition LargeMissileTurret => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Guided Rocket Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
        ...
        WeaponDefinition SmallMissileLauncher => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    PreFiringSound = "", // Audio for warmup effect.
                    FiringSound = "ShipSmallMissileShot", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "ShipGatlingNoAmmo",
            ...
            Ammos = new[] {
                NonReloadMissileAmmoDirect,
                NonReloadMissileAmmoArtilleryBooster,
                NonReloadMissileAmmoArtillery,
                // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        ...
        WeaponDefinition SmallRocketLauncherReload => new WeaponDefinition
        {
            ...
            Ammos = new[] {
                ReloadableMissileAmmo,
                ReloadableMissileAmmoGuided,
                // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        ...
        WeaponDefinition SmallMissileTurret => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                Loading = new LoadingDef
                {
                    ...
                    DegradeRof = false, // Progressively lower rate of fire when over 80% heat threshold (80% of max heat).
                    ShotsInBurst = 2, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
                    DelayAfterBurst = 360, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    FireFull = true, // Whether the weapon should fire the full magazine (or the full burst instead if ShotsInBurst > 0), even if the target is lost or the player stops firing prematurely.
                    GiveUpAfter = false, // Whether the weapon should drop its current target and reacquire a new target after finishing its magazine or burst.
                    BarrelSpinRate = 0, // Visual only, 0 disables and uses RateOfFire.
                    DeterministicSpin = false, // Spin barrel position will always be relative to initial / starting positions (spin will not be as smooth).
