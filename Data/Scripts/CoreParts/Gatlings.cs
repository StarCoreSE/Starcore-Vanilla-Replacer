...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LargeGatlingTurret => new WeaponDefinition
        {
            ...
            {
                PartName = "Gatling Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
        ...
        WeaponDefinition SmallGatlingGun => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    PreFiringSound = "", // Audio for warmup effect.
                    FiringSound = "ShipGatlingShot", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "ShipGatlingNoAmmo",
                    HardPointRotationSound = "", // Audio played when turret is moving.
        ...
        WeaponDefinition SmallGatlingTurret => new WeaponDefinition
        {
            ...
            Ammos = new[] {
                GatlingTurretAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };
