...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LargeBlockRailgun => new WeaponDefinition
        {
            ...
            {
                PartName = "Cycling Rail Capacitors", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
        ...
        WeaponDefinition SmallBlockRailgun => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    PreFiringSound = "RailgunSmallCharge", // Audio for warmup effect.
                    FiringSound = "RailgunSmallShot", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "ShipGatlingNoAmmo",
                    HardPointRotationSound = "", // Audio played when turret is moving.
